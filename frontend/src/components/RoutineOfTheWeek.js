...
const RoutineOfTheWeek = ({ routine }) => {
  return (
    <div className=" flex-none mx-auto w-10/12 text-center cursor-pointer snap-center">
      <Link
        to={
          // {"4242/routines"}
      ...
      >
        <div className="w-10/12 m-auto py-4 px-2 rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
